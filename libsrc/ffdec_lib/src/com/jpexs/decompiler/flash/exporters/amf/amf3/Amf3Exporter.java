        ...
        if (object instanceof AbstractVectorType) {
            ...
            if (ot.isSerialized()) {
                ...
                if (serData == null) {
                    ...
                    ret.append(indent(level + 1)).append("\"serialized\": \"").append(Helper.printHexBinary(serData)).append("\",").append(newLine);
            ...
            return "{" + newLine
                    ...
                    + addId
                    + indent(level + 1) + "\"value\": \"" + Helper.printHexBinary(data) + "\"" + newLine
                    + indent(level) + "}";
